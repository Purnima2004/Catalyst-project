...
SKILL_KEYWORDS = {
    ...
    "Advanced SQL": ["EXPLAIN", "EXPLAIN ANALYZE", "index", "composite index", "partition", "CTE",
                     "materialized view", "window function", "slow query", "execution plan", "ANALYZE",
                     "pg_stat", "full table scan", "covering index", "partial index"],
    "Advanced SQL and Query Optimization": ["EXPLAIN", "EXPLAIN ANALYZE", "index", "composite index",
                                             ...
                                             "slow query", "execution plan", "pg_stat", "covering index",
                                             "partial index", "ANALYZE"],
